...
<div class="container-fluid">
    <div class="row">
         ...
         <a href="../form/cadastroCargo.php" class="btn-circle btn-lg custom-link"  title="Cadastrar Ocorrencia"><i class="icoLojaCadastro fas fa-plus-circle"></i> </a>        
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="myModalLabel">Deseja editar esse cargo?</h4>                     
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>                              
                </div>
                <div classs="modal-body">
                <form method="POST" action="../../model/cargo/edita.php?id=<?php echo $dados['id_cargo']; ?>" class="ml-2">
                  <div class="form-row ml-3">
                      <div class="form-group col-sm-8">
                          <label for="nome">Descrição Cargo:</label>
                          <input type="text" id="nome" class="form-control" name="nome" value="<?php echo $dados['descricao_cargo']; ?>">
                      </div>
                  </div>
                  <div class="form-row ml-3">
                      <div class="form-group col-sm-8">
                          <label for="nivel">Nível do Cargo:</label>
                          <input type="text" id="nivel" class="form-control" name="nivel"  value="<?php echo $dados['nivel_id']; ?>">
                      </div>
                  </div>
                </div>

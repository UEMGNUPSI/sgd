...
<div class="container-fluid">
    <div class="row">
         ...
         <a href="../form/cadastroDepartamentos.php" class="btn-circle btn-lg custom-link"  title="Cadastrar Ocorrencia"><i class="icoLojaCadastro fas fa-plus-circle"></i> </a>        
            <h1 style="font-weight: 330;" class="col-10 text-center">
                <i class="fas fa-laptop-house" style="color: #337ab7; "></i>
                Departamentos
            </h1>    
    </div>    
...
<div class="modal fade" id="editar<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="../../model/departamento/edita.php?id=<?php echo $dados['id_departamento']; ?>" class="ml-2">
                  <div class="form-row ml-3">
                      <div class="form-group col-sm-8">
                          <label for="desc">Descrição Departamento:</label>
                          <input type="text" id="desc" class="form-control" name="desc" value="<?php echo $dados['nome']; ?>">
                      </div>
                  </div>
                  <div class="form-row ml-3">
                      <div class="form-group col-sm-8">

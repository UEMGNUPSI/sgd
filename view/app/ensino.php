...
<div class="container-fluid">
    <div class="row">
         ...
         <a href="../form/cadastroEnsino.php" class="btn-circle btn-lg custom-link"  title="Cadastrar Ocorrencia"><i class="icoLojaCadastro fas fa-plus-circle"></i> </a>        
            ...
            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
              ...
              <?php 
                  ...
                  while ($dados = mysqli_fetch_assoc($consulta)) {   
                    $id = $dados['id_ensino'];                                 
                      echo "<tr>";
                      echo "<td>" . $dados['nome'] . "</td>"; //nome ocorrencia ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="myModalLabel">Deseja editar esse Nível de Ensino?</h4>                     
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>                              
                </div>
                <div classs="modal-body">
                <form method="POST" action="../../model/nivel_ensino/edita.php?id=<?php echo $dados['id_ensino']; ?>" class="ml-2">
                  <div class="form-row ml-3">
                      <div class="form-group col-sm-8">
                          <label for="nome">Descrição Nível de Ensino:</label>

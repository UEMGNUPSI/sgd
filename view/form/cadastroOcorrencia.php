...
<div class="container-fluid">
    ...
    <form method="POST" action="../../model/ocorrencia/cadastro.php">
        <div class="form-row ">
            <div class="form-group col-sm-6">
                <label for="nome">Descrição Ocorrência:</label>
                <input type="text" id="nome" class="form-control" name="description">
            </div>
            <div class="form-group col-sm-6">
                <label for="nome">Pessoa:</label>
                <select id="pessoa" class="form-control" name="person">

...
<div class="container-fluid">
    ...
    <form method="POST" action="../../model/departamento/cadastro.php">
        <div class="form-row ">
            <div class="form-group col-sm-6">
                <label for="nome">Nome:</label>
                <input type="text" id="nome" class="form-control" name="name" maxlength="255">
            </div>
            <div class="form-group col-sm-6">
                <label for="nome">Sigla:</label>
                <input type="text" id="nome" class="form-control" name="flag" maxlength="10">
            </div>
        </div> <!-- Fim row -->

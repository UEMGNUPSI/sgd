...
<div class="container-fluid">
    ...
    <form method="POST" action="../../model/curso/cadastro.php">
        <div class="form-row ">
            <div class="form-group col-sm-8">
                <label for="nome">Descrição Curso:</label>
                <input type="text" id="nome" class="form-control" name="desc" maxlength="255">
            </div>
        ...
        <div class="form-row ">
            <div class="form-group col-sm-3">
                ...
                <input type="text" id="nome" class="form-control" name="modalidade" maxlength="50">
            </div>
            <div class="form-group col-sm-3">
                <label for="nome">N° Semestres:</label>
                <input type="text" id="nome" class="form-control" name="semestres" maxlength="4">
            </div>
            <div class="form-group col-sm-3">
                <label for="nome">Turno:</label>
                <input type="text" id="nome" class="form-control" name="turno" maxlength="50">
            </div>
            <div class="form-group col-sm-3">
                <label for="nome">N° Vaga:</label>
                <input type="text" id="nome" class="form-control" name="vaga" maxlength="4">
            </div>
        </div> <!-- Fim row -->
